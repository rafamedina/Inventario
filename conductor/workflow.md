...
8. **Commit Code Changes with Task Summary:**
   ...
   - Include the detailed task summary in the commit message body.
   - Perform the commit.
...
# (For Odoo 18, use appropriate env)
```

### Daily Development
```bash
# Update the module in Odoo
# odoo-bin -c <path_to_conf> -u Inventario

# Run tests
# odoo-bin -c <path_to_conf> -d <db_name> -i Inventario --test-enable --stop-after-init
```
...
9. Changes committed with proper message including task summary body
